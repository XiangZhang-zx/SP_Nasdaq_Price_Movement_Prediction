...
# 设置文件路径
file_path_ixic = '/usr3/graduate/xz0224/oc（就是从今天的open买，今天的close卖）/ixic.csv'
...
file_path = '/usr3/graduate/xz0224/oc（就是从今天的open买，今天的close卖）/ixic/investment_results_final(2006)(train_3month_c-c).xlsx'
