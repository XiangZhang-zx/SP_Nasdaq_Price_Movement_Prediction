...
# 设置文件路径
file_path_spyv = '/usr3/graduate/xz0224/oc（就是从今天的open买，今天的close卖）/spyv.csv'
file_path_spyg = '/usr3/graduate/xz0224/oc（就是从今天的open买，今天的close卖）/spyg.csv'
...
file_path = '/usr3/graduate/xz0224/oc（就是从今天的open买，今天的close卖）/加强_mc/investment_results_final(2006)(train_1years_c-c)_加强.xlsx'
