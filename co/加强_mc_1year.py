...
# 设置文件路径
file_path_spyv = '/usr3/graduate/xz0224/co（就是从close买，明天的open卖）/spyv.csv'
file_path_spyg = '/usr3/graduate/xz0224/co（就是从close买，明天的open卖）/spyg.csv'
file_path_spy = '/usr3/graduate/xz0224/co（就是从close买，明天的open卖）/spy.csv'
...
file_path = '/usr3/graduate/xz0224/co（就是从close买，明天的open卖）/加强_mc/investment_results_final(2006)(train_1years_c-c)_加强.xlsx'
...
while current_date <= end_date:
    ...
    if not test_set.empty:
        ...
        # 创建 LSTM 模型
        model = Sequential()
        model.add(LSTM(50, return_sequences=True, input_shape=(max_length, 1)))
