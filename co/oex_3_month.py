...
# 设置文件路径
file_path_oex = '/usr3/graduate/xz0224/co（就是从close买，明天的open卖）/oex.csv'
...
file_path = '/usr3/graduate/xz0224/co（就是从close买，明天的open卖）/oex/investment_results_final(2006)(train_3month_c-c).xlsx'
...
while current_date <= end_date:
    ...
    if not train_set.empty and len(train_set['target'].unique()) > 1 and not test_set.empty:
        # 现在进行 LSTM 模型训练的其他步骤
